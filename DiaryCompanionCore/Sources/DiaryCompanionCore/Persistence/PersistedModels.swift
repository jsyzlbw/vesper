...
@Model public final class JournalSettingsRecord {
    ...
    public var isMorningPromptEnabled: Bool = false
    public var isEveningPromptEnabled: Bool = false
    public var isMorningEscalationAlarmEnabled: Bool = false
    public var isEveningEscalationAlarmEnabled: Bool = false
    public var escalationDelayMinutes: Int = 15
    public var isWeeklySummaryEnabled: Bool = false
    public var weeklySummaryWeekday: Int = 1
    public var weeklySummaryHour: Int = 20
    public var weeklySummaryMinute: Int = 0
    public var isCalendarImportEnabled: Bool = false
    public var isHealthImportEnabled: Bool = false
    ...
    public init(
        ...
        isMorningPromptEnabled: Bool = false,
        isEveningPromptEnabled: Bool = false,
        isMorningEscalationAlarmEnabled: Bool = false,
        isEveningEscalationAlarmEnabled: Bool = false,
        escalationDelayMinutes: Int = 15,
        isWeeklySummaryEnabled: Bool = false,
        weeklySummaryWeekday: Int = 1,
        weeklySummaryHour: Int = 20,
        weeklySummaryMinute: Int = 0,
        isCalendarImportEnabled: Bool = false,
        isHealthImportEnabled: Bool = false,
